      ...
      >
        ...
        <div className=" shrink-0 relative md:mr-10">
          {props.image ? (
            ...
            <div className="flex text-[#181818] items-center justify-center font-bold text-lg md:text-2xl rounded-full h-10 w-10 md:h-14 md:w-14 ring-2 ring-[#E5E7EA]">
              {props.companyName
                ? props.companyName
                    .split(" ")
        ...
        <div className="mx-5 grow lg:flex items-center justify-between space-y-5 lg:space-x-2 lg:space-y-0 truncate overflow-ellipsis">
          <div>
            ...
            <div className="-m-1">
              <a
                className={`text-xs text-gray-500 md:font-medium font-normal inline-flex px-1.5 py-0.5 hover:text-gray-600 rounded-lg m-1 whitespace-nowrap transition duration-150 ease-in-out ${
